        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-BP-TB', $listitemdata[2], 'Price', 'Set Your Price', 'false');
                    ...
                    echo oxi_addons_adm_help_image_upload('OxiAddonsEW-BI', $listitemdata[8], 'Banner Image', 'Set Your Event Banner Image', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-BT', $listitemdata[10], 'Box Heading', 'Set Your Box Heading', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-BTime', $listitemdata[12], 'Time Text', 'Set Your Time Text', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-B-BT', $listitemdata[14], 'Button Text', 'Set Your Button Text', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-B-BL', $listitemdata[16], 'Button Link', 'Set Your Button Link', 'false');
                    ?>
                </div>
