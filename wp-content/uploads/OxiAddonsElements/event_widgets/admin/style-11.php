        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_image_upload('OxiAddonsEW-11-G-BI', $listitemdata[2], 'Banner Image', 'Set Your Event Banner Image', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-11-D', $listitemdata[4], 'Date', 'Set Your Event Date, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-11-M', $listitemdata[6], 'Month', 'Set Your Event Month, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-11-TT', $listitemdata[8], 'Time', 'Set Your Event Time, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-11-H', $listitemdata[10], 'Heading Text', 'Set Your heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-11-LI', $listitemdata[12], 'Icon Class', 'Set Your Icon Class', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-11-AT', $listitemdata[14], 'Address Text', 'Set Your Address Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-11-DET', $listitemdata[16], 'Details Text', 'Set Your Details Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-11-DEURL', $listitemdata[18], 'URL', 'Set Your Details Url', 'false');
                    ?>
                </div>
