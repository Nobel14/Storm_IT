        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_image_upload('OxiAddonsEW-8-G-I', $listitemdata[2], 'Banner Image', 'Set Your Event Banner Image', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-8-EL', $listitemdata[4], 'Event Link', 'Set Your Event Link, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-8-H', $listitemdata[6], 'Heading Text', 'Set Your Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-8-SH', $listitemdata[8], 'Sub Heading', 'Set Your Sub Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-8-F-D', $listitemdata[10], 'Date', 'Set Your Date Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-8-F-M', $listitemdata[12], 'Month', 'Set Your Month Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-8-F-T', $listitemdata[14], 'Time', 'Set Your Time, Supported native Language', 'false');
                    ?>
                </div>
