        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-6-N', $listitemdata[2], 'Name', 'Set Your Name, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-6-Y', $listitemdata[4], 'Time', 'Set Your Time Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-6-D', $listitemdata[6], 'Date', 'Set Your Date Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-6-M', $listitemdata[8], 'Month', 'Set Your Month Text, Supported native Language', 'false');
                    ?>
                </div>
