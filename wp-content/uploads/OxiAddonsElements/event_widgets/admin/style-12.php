        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-12-D', $listitemdata[2], 'Date', 'Set Your Date Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-12-M', $listitemdata[4], 'Month', 'Set Your Month Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-12-H', $listitemdata[6], 'Heading', 'Set Your Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-12-DE', $listitemdata[8], 'Name', 'Set Your Designation Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-12-DE-I', $listitemdata[10], 'Icon Class', 'Set Your Icon Class', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-12-T', $listitemdata[12], 'Time', 'Set Your Time text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-12-T-I', $listitemdata[14], 'Icon Class', 'Set Your Icon Class', 'false');
                    ?>
                </div>
