        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_image_upload('OxiAddonsEW-7-I', $listitemdata[2], 'Banner Image', 'Set Your Event Banner Image', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-7-H', $listitemdata[4], 'Heading Text', 'Set Your Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-7-T', $listitemdata[6], 'Time Text', 'Set Your Time Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-7-IC', $listitemdata[8], 'Time Icon Class', 'Set Your Time Icon Class', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-7-AD', $listitemdata[10], 'Address', 'Set Your Address Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-7-ICA', $listitemdata[12], 'Address Icon Class', 'Set Your Address Icon Class', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-7-L', $listitemdata[14], 'Link Text', 'Set Your Link Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-7-ICL', $listitemdata[18], 'Link Icon Class', 'Set Your Link Icon Class, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-7-LURL', $listitemdata[16], 'URL', 'Set Your Url', 'false');
                    ?>
                </div>
