        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-time', $listitemdata[3], 'Time', 'Set your event Time With Text', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-location', $listitemdata[9], 'Location', 'Set Event Location', '');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-month', $listitemdata[13], 'Month', 'Set your event Month', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-day', $listitemdata[15], 'Day', 'Set your event Day', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-title', $listitemdata[5], 'Title', 'Set your event Title', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-link', $listitemdata[17], 'Title Link', 'Set your event Title Link', 'false');
