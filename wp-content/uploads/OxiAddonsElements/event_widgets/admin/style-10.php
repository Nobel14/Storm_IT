        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_image_upload('OxiAddonsEW-10-G-BI', $listitemdata[2], 'Banner Image', 'Set Your Event Banner Image', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-FT', $listitemdata[16], 'Time Text', 'Set Your Time Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-FT-I', $listitemdata[18], 'Time Icon Class', 'Set Your Time Icon', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-AT', $listitemdata[20], 'Address Text', 'Set Your Address Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-AT-I', $listitemdata[22], 'Address Icon Class', 'Set Your Address Icon', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-D-H', $listitemdata[4], 'Day Text', 'Set Your Day Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-M-H', $listitemdata[6], 'Month Text', 'Set Your Month Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-H', $listitemdata[8], 'Heading Text', 'Set Your Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-HURL', $listitemdata[10], 'URL', 'Set Your Url', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-L', $listitemdata[12], 'Link Text', 'Set Your Link Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-10-LU', $listitemdata[14], 'URL', 'Set Your Url,', 'false');
                    ?>
                </div>
