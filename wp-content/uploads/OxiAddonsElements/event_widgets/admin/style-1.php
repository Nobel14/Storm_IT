        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-D', $listitemdata[2], 'Date', 'Set Your Event Date, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-M', $listitemdata[4], 'Month', 'Set Your Event Month, Supported native Language', 'false');
                    echo oxi_addons_adm_help_image_upload('OxiAddonsEW-I', $listitemdata[6], 'Banner Image', 'Set Your Event Banner Image', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-H', $listitemdata[8], 'Heading Text', 'Set Your Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_form_textarea('OxiAddonsEW-IT', $listitemdata[10], 'Info Text', 'Give Your Info text Here', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-B', $listitemdata[12], 'Button Text', 'Set Your Button Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-B-URL', $listitemdata[14], 'Button Link', 'Set Your Button Link', 'false');
                    ?>
                </div>
