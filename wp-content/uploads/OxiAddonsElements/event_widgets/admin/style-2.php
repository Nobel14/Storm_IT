        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-2-D', $listitemdata[2], 'Date', 'Set Your Event Date', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-2-M', $listitemdata[4], 'Month', 'Set Your Event Month', 'false');
                    echo oxi_addons_adm_help_image_upload('OxiAddonsEW-2-BG', $listitemdata[6], 'Banner Image', 'Set Your Event Banner Image', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-2-H', $listitemdata[8], 'Heading Text', 'Set Your Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-2-H2', $listitemdata[10], 'Sub Heading Text', 'Set Your Sub Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-2-L', $listitemdata[12], 'Location Text', 'Set Your Location Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-2-L-I', $listitemdata[14], 'Icon Class', 'Set Your Location Icon', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-2-B', $listitemdata[16], 'Button Text', 'Set Your Button Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-2-B-URL', $listitemdata[18], 'Button Link', 'Set Your Button Link', 'false');
                    ?>
                </div>
