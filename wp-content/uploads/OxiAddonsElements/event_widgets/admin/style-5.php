        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-5-D', $listitemdata[2], 'Date', 'Set Your Date Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-5-T', $listitemdata[4], 'Time', 'Set Your Time Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-5-N', $listitemdata[6], 'Name', 'Set Your Name Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-5-AD', $listitemdata[8], 'Address', 'Set Your Address Text, Supported native Language', 'false');
                    ?>
                </div>
