        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_image_upload('OxiAddonsEW-9-G-I', $listitemdata[2], 'Banner Image', 'Set Your Event Banner Image', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-9-H', $listitemdata[4], 'Heading Text', 'Set Your Heading Text, Supported native Language', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-9-HI', $listitemdata[6], 'Icon Class', 'Set Your Icon Class', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonsEW-9-SH', $listitemdata[8], 'Description', 'Set Your Description Text, Supported native Language', 'false');
                    ?>
                </div>
