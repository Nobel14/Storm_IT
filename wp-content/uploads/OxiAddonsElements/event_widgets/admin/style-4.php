                ...
                <div class="modal-body">
                    <div class="oxi-addons-col-1">
                        <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-content-div-body">
                                <?php
                                echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-time', $listitemdata[1], 'Time', 'Set your event Time With Text', 'false');
                                echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-title', $listitemdata[3], 'Title', 'Set your event Title', 'false');
                                echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-author', $listitemdata[5], 'Author', 'Set your event Author Info', 'false');
                                echo oxi_addons_adm_help_image_upload('OxiAddonsEW-M-image', $listitemdata[7], 'User Image', 'Set Author Image For this Event', '');
                                echo oxi_addons_adm_help_textbox('OxiAddonsEW-M-location', $listitemdata[9], 'Location', 'Set Author Image For this Event', '');
                                ?>
                            </div>
                        </div>
                        <div class="oxi-addons-content-div">
