...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = ' OxiAddCB-button-class ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddCB-button-class']) . '||#||'
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpItemPerRows('OxiAddIconBoxes-rows', $styledata, 307, 'false', '.oxi-addons-admin-edit-list');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-radius', 35, $styledata, 1, 'Border Radius', 'Set Your Content Boxes Border', 'true', '.oxi-addons-content-boxes-' . $oxiid . '-data', 'border-radius');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-i-padding', 285, $styledata, 1, 'Padding', 'Set Your Icon Padding', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-icons', 'padding');
                                         ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Animation('OxiAddCB-i-animation', 301, $styledata, 'true', '.oxi-addons-content-boxes-icon');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-heading-color', $styledata[121], '', 'Color', 'Select Your Heading Color', '', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-heading', 'color');
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-2">
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_true_false('OxiAddCB-button-link-opening', $styledata[13], 'Normal', '', 'New Tab', '_blank', 'Link Opening', 'Customize your Link Opening Style');
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-hover-button-border', 241, $styledata, 1, 'Border', 'Set Your Content Boxes Border', 'true', '.oxi-addons-container .oxi-button-' . $oxiid . ':hover', 'border-width');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_content_boxes_style_2_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddCB-i-class', $listitemdata[11], 'Icon Class', 'Set your Icon Class');
                    echo oxi_addons_adm_help_textbox('OxiAddCB-heading-text', $listitemdata[3], 'Heading Text', 'Set your Heading text');
                    echo oxi_addons_adm_help_form_textarea('OxiAddCB-content', $listitemdata[5], 'Short Detail', 'Write Your Content Boxes Short Details');
                    echo oxi_addons_adm_help_textbox('OxiAddCB-button-class', $listitemdata[1], 'Button Text', 'Set your Button Text');
