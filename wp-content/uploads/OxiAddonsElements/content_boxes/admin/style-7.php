        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-wrapper">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpItemPerRows('OxiAddIconBoxes-rows', $styledata, 251, 'false', '.oxi-addons-admin-edit-list');
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-2">
                                ...
                                <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_true_false('OxiAddCB-button-link-opening', $styledata[255], 'Normal', '', 'New Tab', '_blank', 'Link Opening', 'Customize your Link Opening Style');
                                ...
                                <div class="oxi-addons-col-6">      
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-button-color', $styledata[127], '', 'Color', 'Select Your Icon Color', 'false', '.oxi-addons-content-boxes-button .oxi-button-' . $oxiid . '', 'color');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-button-border', 163, $styledata, 1, 'Border', 'Set Your Content Boxes Border width', 'true', '.oxi-addons-content-boxes-button .oxi-button-' . $oxiid . '', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiAddCB-button-border', 179, $styledata, 'true', '.oxi-addons-content-boxes-button .oxi-button-' . $oxiid . '', 'border');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-button-radius', 183, $styledata, 1, 'Border Radius', 'Set Your Content Boxes Border Radius ', 'true', '.oxi-addons-content-boxes-button .oxi-button-' . $oxiid . '', 'border-radius');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-button-margin', 235, $styledata, 1, 'Margin', 'Set Your Heading Margin ', 'true', '.oxi-addons-content-boxes-button .oxi-button-' . $oxiid . '', 'margin');
                                           ?>
                                        </div>
                                        <div class="oxi-head">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-button-hover-color', $styledata[151], '', ' Color', 'Select Your Button Hover Text Color', '', '');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-button-hover-bgcolor', $styledata[155], 'rgba', 'Background Color', 'Select Your Button Hover Background Color', '', '');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-hover-button-border', 199, $styledata, 1, 'Border', 'Set Your Content Boxes Border Top Bottom and Left Right');
                                            echo OxiAddonsADMhelpBorder('OxiAddCB-hover-button-border', 215, $styledata);
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-hover-button-radius', 219, $styledata, 1, 'Border Radius', 'Set Your Content Boxes Border Radius Top Bottom and Left Right');
                                            ?>
                                        </div>
                                    </div> 
                                </div>    
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_content_boxes_style_7_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
