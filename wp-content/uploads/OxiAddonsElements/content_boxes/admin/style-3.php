...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddCB-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddCB-hover-button-border') . ''
                ...
                . ' OxiAddCB-i-align |' . sanitize_text_field($_POST['OxiAddCB-i-align']) . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddCB-i-padding') . ''
                . '' . oxi_addons_adm_help_animation_senitize('OxiAddCB-i-animation') . ''
                . '' . oxi_addons_adm_help_single_size('OxiAddCB-i-width') . ''
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddCB-i-border') . ''
                . '' . OxiAddonsADMHelpBorderSanitize('OxiAddCB-i-border') . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddCB-i-radius') . ''
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpItemPerRows('OxiAddIconBoxes-rows', $styledata, 347, 'false', '.oxi-addons-admin-edit-list');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-border', 15, $styledata, 1, 'Border-width', 'Set Your Content Boxes Border width', 'true', '.oxi-addons-content-boxes-' . $oxiid . '-data', 'border-width');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddCB-i-width', $styledata[305], $styledata[306], $styledata[307], 1, 'Width Height', 'Set Your content Boxes Width Height', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-oxi-icons', 'width');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddCB-i-size', $styledata[277], $styledata[278], $styledata[279], 1, 'Size', 'Select Your Icon Size', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-icons', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-i-color', $styledata[281], '', 'Color', 'Select Your Icon Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-icons', 'color');
                                            echo oxi_addons_adm_help_Text_Align('OxiAddCB-i-align', $styledata[283], 'Icon Align', 'Set Your Icon Align', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-icon', 'text-align');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-i-border', 309, $styledata, 1, 'Border Width', 'Set Your Content Boxes Border width', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-icon-data::before', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiAddCB-i-border', 325, $styledata, 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-icon-data::before', 'border');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-i-radius', 329, $styledata, 1, 'Border Radius', 'Set Your Content Boxes Border Radius', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-icon-data::before', 'border-radius');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-i-padding', 285, $styledata, 1, 'Padding', 'Set Your Icon Padding', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-icon-data', 'padding');
                                           ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                          echo oxi_addons_adm_help_Animation('OxiAddCB-i-animation', 301, $styledata);    ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        <div class="oxi-head">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddCB-heading-size', $styledata[117], $styledata[118], $styledata[119], 1, 'Font Size', 'Select Your Heading Font Size', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-heading', 'font-size');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddCB-content-size', $styledata[145], $styledata[146], $styledata[147], 1, 'Font Size', 'Select Your Content Font Size', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-content', 'font-size');
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-2">
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_true_false('OxiAddCB-button-link-opening', $styledata[345], 'Normal', '', 'New Tab', '_blank', 'Link Opening', 'Customize your Link Opening Style');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                             echo oxi_addons_adm_help_Animation('OxiAddCB-b-animation', 173, $styledata, 'true', '.oxi-addons-content-boxes-button');
                                             ?>
                                        </div>
                                    </div>   
                                </div>
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-button-color', $styledata[97], '', 'Color', 'Select Your Icon Color', '', '.oxi-addons-content-boxes-button .oxi-button-' . $oxiid . '', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-button-bgcolor', $styledata[179], 'rgba', 'Background Color', 'Select Your Button Background Color', '', '.oxi-addons-content-boxes-button .oxi-button-' . $oxiid . '', 'background');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-button-border', 205, $styledata, 1, 'Border', 'Set Your Content Boxes Border width', 'true', '.oxi-addons-content-boxes-button .oxi-button-' . $oxiid . '', 'border-width');
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-button-hover-color', $styledata[177], '', ' Color', 'Select Your Button Hover Text Color', '', '.oxi-addons-container .oxi-button-' . $oxiid . ':hover', 'color');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-hover-button-border', 241, $styledata, 1, 'Border', 'Set Your Content Boxes Border width', 'true', '.oxi-addons-container .oxi-button-' . $oxiid . ':hover', 'border-width');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-hover-button-radius', 261, $styledata, 1, 'Border Radius', 'Set Your Content Boxes Border Radius', 'true', '.oxi-addons-container .oxi-button-' . $oxiid . ':hover', 'border-radius');
                                            ?>
                                        </div>
                                    </div> 
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_content_boxes_style_3_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_textbox('OxiAddCB-button-id', $listitemdata[9], 'Button ID', 'Write If you want to Add any ID into Your Button');
                    echo oxi_addons_adm_help_textbox('OxiAddCB-button-link', $listitemdata[11], 'Desire Link', 'Write If you want to Add and Link into Your Button');
                    ?>
                </div>
