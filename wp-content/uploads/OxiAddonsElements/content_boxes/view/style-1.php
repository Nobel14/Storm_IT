...
function oxi_content_boxes_style_1_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    ...
    foreach ($listdata as $value) {
        ...
        if ($data[8] != '') {
            $href = 'href="' . OxiAddonsUrlConvert($data[8]) . '"';
            if ($styledata[277] != '') {
    ...
    $css .= '.oxi-addons-content-boxes-' . $oxiid . '{
                ...
                .oxi-addons-container  .oxi-button-' . $oxiid . ':active{
                    ...
                    border-width: ' . OxiAddonsPaddingMarginSanitize($styledata, 241) . ';
                ...
                @media only screen and (min-width : 669px) and (max-width : 993px){
                   .oxi-addons-content-boxes-' . $oxiid . '{
                    ...
                    .oxi-addons-container  .oxi-button-' . $oxiid . ':active{
                        ...
                        border-width: ' . OxiAddonsPaddingMarginSanitize($styledata, 242) . ';
                    }
                }
                @media only screen and (max-width : 668px){
                    ...
                    .oxi-addons-container  .oxi-button-' . $oxiid . ':active{
                        ...
                        border-width: ' . OxiAddonsPaddingMarginSanitize($styledata, 243) . ';
                    }
                }
                ';
