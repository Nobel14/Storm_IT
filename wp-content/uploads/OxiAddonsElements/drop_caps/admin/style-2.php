...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddDropCaps-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . ' OxiAddDropCaps-bg-color |' . sanitize_text_field($_POST['OxiAddDropCaps-bg-color']) . '|'
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('OxiAddDropCaps-color', $styledata[43], '', 'Color', 'Select Your  Color', 'false', '.oxi-addons-drop-caps-' . $oxiid . '', 'color');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddDropCaps-bg-color', $styledata[51], 'rgba', 'Background', 'Select Your  Background Color', '', '.oxi-addons-drop-caps-' . $oxiid . '', 'color');
