...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddDropCaps-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . ' ||'
                . ' OxiAddDropCaps-border-radius |' . sanitize_text_field($_POST['OxiAddDropCaps-border-radius']) . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddDropCaps-border') . ''
                . ' OxiAddDropCaps-border||' . sanitize_text_field($_POST['OxiAddDropCaps-border-type']) . '|' . sanitize_hex_color($_POST['OxiAddDropCaps-border-color']) . '|'
                . '||||'
                . 'oxi-addons-bg-image-overlay |' . sanitize_text_field($_POST['oxi-addons-bg-image-overlay']) . '|' 
                . '||#||  ||#||'
                ...
                . 'OxiAddons-drop-caps-IMG ||#||' . OxiAddonsAdminUrlConvert($_POST['OxiAddons-drop-caps-IMG']) . '||#||'
                . '|';
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_image_upload('OxiAddons-drop-caps-IMG', $stylefiles[9], 'Uplod Image', 'Uplod Text bg image');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-bg-image-overlay', $styledata[79], 'rgba', 'Image Overlay Color', 'Text bacjground image overlay', '');
                                        echo oxi_addons_adm_help_true_false('OxiAddDropCaps-position', $stylefiles[7], 'Left', 'left', 'Right', 'right', 'Position', 'Select Position');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddDropCaps-padding', 3, $styledata, 1, 'Padding', 'Set Your Button Size Top Bottom and Left Right', 'true', '.oxi-addons-drop-caps-' . $oxiid . '', 'padding');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiAddDropCaps-border', 55, $styledata, 1, 'Border width', 'Set Your Border width', 'true', '.oxi-addons-drop-caps-' . $oxiid . '', 'border-width');
                                        echo OxiAddonsADMhelpBorder('OxiAddDropCaps-border', 72, $styledata, '', '.oxi-addons-drop-caps-' . $oxiid . '', 'border');
                                        ...
                                        echo oxi_addons_adm_help_Font_Weight('OxiAddDropCaps-font-weight', $styledata[47], 'Font Weight', 'Select Your Font Weight', 'true', '.oxi-addons-drop-caps-' . $oxiid . '');
                                        ...
                                        echo oxi_addons_adm_help_number('OxiAddDropCaps-border-radius', $styledata[53], 1, 'Border Radius', 'Set your Border Radius', 'true', '.oxi-addons-drop-caps-' . $oxiid . '', 'border-radius');
                                        ?>
                                    </div>
                                </div>
                            </div>
