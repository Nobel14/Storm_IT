...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-divider-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '||||'
                . '||'
                . '' . OxiAddonsADMHelpFontSettingsSanitize('oxi-addons-divider') . ''
                . '||#|| oxi_addons-divider-id ||#||' . sanitize_text_field($_POST['oxi_addons-divider-id']) . '||#||'
                . '||#|| oxi_addons-divider-text ||#||' . sanitize_text_field($_POST['oxi_addons-divider-text']) . '||#||'
                . '  ||#||';
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('oxi_addons-divider-text', $stylefiles[5], 'Text', 'Write Your Text');
                                        ...
                                        echo OxiAddonsADMHelpFontSettings('oxi-addons-divider', 65, $styledata, 'true', '.oxi-divider-' . $oxiid . ' .oxi-text');
