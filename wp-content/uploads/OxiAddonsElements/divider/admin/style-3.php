                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-divider-size', $styledata[7], $styledata[8], $styledata[9], 1, 'Size', 'Your Divider Width', 'true', 'oxi-addons-divider-size', 'max-width');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_border('oxi-addons-divider-border', $styledata[59], $styledata[60], 'Icon Border', 'Set Your Divider Icon Border with Size and Type', 'true', '.oxi-divider-' . $oxiid . ' .oxi-icons');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-divider-border-color', $styledata[61], '', 'Border Color', 'Select Your Divider Icon Border Color', '', '.oxi-divider-' . $oxiid . ' .oxi-icons', 'border-color');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-divider-font-padding', 43, $styledata, 1, 'Padding', 'Set Your divider Icon or Text Padding Top Bottom and Left Right', 'true');
                                        echo oxi_addons_adm_help_number('oxi-addons-divider-border-radius', $styledata[63], '1', 'Border Radius', 'Set Icon Border Radius', 'true', '.oxi-divider-' . $oxiid . ' .oxi-icons', 'border-radius');
                                        ?>
                                    </div>
                                </div>
                            </div>
